...
const CategoryPage = () => {
  ...
  const { data: categoriesData, loading, error, refetch } = useGet("/categories");
        ...
        if (categoriesData?.data) {
          const updatedCategories = categoriesData.data.filter(category => {
            const removeCategory = (cat) => {
              ...
              if (cat.children) {
                cat.children = cat.children.filter(child => removeCategory(child));
              }
              return true;
            };
        ...
        <div key={category.id}>
          <div className="flex items-center p-2 hover:bg-gray-50 border-b">
            ...
            <div className="flex-1 min-w-0 mr-4">
              ...
              <div className="text-sm text-gray-500 truncate" title={category.slug}>
                {category.slug}
              </div>
            </div>
            ...
            <div className="w-24 flex-shrink-0 mr-4">
              <span className={`px-2 py-1 text-xs rounded ${category.status === 1 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
            ...
            <div className="w-32 flex-shrink-0 mr-4">
              <div className="text-sm text-gray-600 truncate" title={category.created_by || 'N/A'}>
            ...
            {/* Updated By Column */}
            <div className="w-32 flex-shrink-0 mr-4">
              <div className="text-sm text-gray-600 truncate" title={category.updated_by || 'N/A'}>
      ...
      <Card>
        <CardHeader variant="gradient" color="blue" className="mb-8 p-6">
          <div className="flex items-center justify-between">
            ...
            >
              <PlusIcon className="h-4 w-4" color="black" /> <span className="text-black">Add Category</span>
            </Button>
          </div>
        </CardHeader>
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          ...
          <div className="flex items-center p-4 bg-gray-50 border-b">
            ...
            <div className="flex-1 min-w-0 mr-4 font-semibold">Category Name</div>
            <div className="w-24 flex-shrink-0 mr-4 font-semibold">Status</div>
            <div className="w-32 flex-shrink-0 mr-4 font-semibold">Created By</div>
            <div className="w-32 flex-shrink-0 mr-4 font-semibold">Updated By</div>
            <div className="w-20 flex-shrink-0 font-semibold text-right">Actions</div>
          </div>
      ...
      >
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm mx-auto overflow-hidden">
          <DialogHeader className="justify-between py-4 px-6 bg-gradient-to-r from-red-500 to-red-600">
            <Typography variant="h6" color="white" className="text-center w-full font-semibold">
              Delete Category
            </Typography>
            <IconButton
              color="white"
            ...
            {deleteError ? (
              ...
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div>
                  ...
                  <Typography variant="small" color="gray" className="font-normal max-w-[240px]">
